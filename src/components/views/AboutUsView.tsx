...
export default function AboutUsView() {
    return (
        <main className="pt-40 md:pt-24 pb-24 px-6 w-full bg-white min-h-screen flex flex-col items-center justify-start md:justify-center relative overflow-y-auto">
            ...
            <div className="max-w-6xl w-full mx-auto px-6 h-auto md:h-screen md:max-h-screen md:overflow-hidden flex flex-col justify-start md:justify-center py-8 md:py-0">
